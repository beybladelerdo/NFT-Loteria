...
{#if isLoading || !user}
    <FullScreenSpinner />
{:else}
    <div class="flex items-center justify-center min-h-screen px-4 py-12 font-mono bg-BrandBackground text-BrandText">
        <div class="flex flex-col items-center w-full max-w-md p-8 space-y-6 border rounded-lg shadow-lg bg-BrandSurface border-BrandBorder">
            <h1 class="mb-2 text-3xl retro-text text-BrandHighlight">Profile</h1>
            <div class="w-full">
                <label for="profile-username" class="block mb-1 text-sm text-BrandSecondary">Username</label>
                <div class="flex items-center justify-between px-4 py-3 mb-4 border rounded-lg bg-BrandAccent border-BrandBorder">

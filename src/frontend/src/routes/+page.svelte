...
<div class="relative min-h-screen bg-[#1a0033] overflow-x-hidden">
  ...
  <div class="relative z-10 py-8 md:py-12 px-4">
    <section class="relative mx-auto w-full max-w-[1200px]">
      <div class="mb-12">
        <div class="mx-auto max-w-3xl text-center">
          <h1
            class="text-4xl md:text-6xl font-black uppercase mb-2 arcade-text-shadow"
          >
            <span class="text-[#F4E04D]">OWN YOUR</span>
            <span class="text-[#C9B5E8]">TABLA</span>
          </h1>
          <h2
            class="text-3xl md:text-5xl font-black text-[#F4E04D] uppercase mb-6 arcade-text-shadow"
          >
            NFT LOTERÍA
          </h2>
          <p
          ...
          <div class="flex items-center justify-center gap-4 flex-wrap">
            <button
              onclick={dashboard}
              class="arcade-button px-8 py-4 text-sm md:text-base"
            >
              LAUNCH APP
            </button>
            <button
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
        <div
          class="arcade-panel p-6 hover:shadow-[12px_12px_0px_rgba(0,0,0,0.8)] hover:-translate-y-1 transition-all"
        >
          ...
          <h3
            class="text-2xl font-black text-[#F4E04D] uppercase mb-3 arcade-text-shadow"
          >
            MEET THE DECK
          </h3>
        ...
        >
          ...
          <h3
            class="text-2xl font-black text-[#C9B5E8] uppercase mb-3 arcade-text-shadow"
          >
            BINGO!
          </h3>
        ...
        >
          ...
          <h3
            class="mb-2 text-lg font-black text-white uppercase arcade-text-shadow"
          >
            JOIN THE FUN!
          </h3>
          <p class="mb-5 text-sm font-bold text-white">
          ...
          <div class="grid grid-cols-3 gap-2 mb-4">
            <div
              class="arcade-panel-sm border-[#F4E04D] p-3 rounded text-center"
            >
              <img
                src="/tokens/ICP.svg"
                alt="ICP"
            ...
            <div
              class="arcade-panel-sm border-[#FF9900] p-3 rounded text-center"
            >
              <img
            ...
            <div
              class="arcade-panel-sm border-[#FFD700] p-3 rounded text-center"
            >
              <img
                src="/tokens/gldt.png"
                alt="GLDT"
          ...
          <div
            class="bg-gradient-to-r from-[#F4E04D] to-[#FFD700] border-2 border-black p-3 mb-4 text-center shadow-[3px_3px_0px_rgba(0,0,0,1)]"
          >
    ...
    <footer class="mx-auto mt-12 max-w-[1200px] text-center">
      <div
        class="arcade-panel px-8 py-5 inline-block font-bold text-sm uppercase text-[#F4E04D]"

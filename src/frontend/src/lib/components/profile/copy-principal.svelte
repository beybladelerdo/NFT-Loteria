...
<div
  class="flex items-center justify-between px-4 py-2 border rounded-lg {bgColor} {borderColor}"
>
  <p class="font-mono text-sm truncate text-BrandWhite">
  ...
  <button
    ...
    class="p-2 ml-2 text-white transition-colors duration-200 rounded-lg hover:bg-BrandBlack"
  >

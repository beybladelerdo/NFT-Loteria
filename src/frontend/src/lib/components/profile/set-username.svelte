...
{:else}
  <div
    class="flex flex-col items-center justify-center min-h-screen px-4 py-12 font-mono bg-BrandBackground text-BrandText"
  >
    <div
      class="w-full max-w-md p-8 space-y-6 border rounded-lg shadow-lg bg-BrandSurface border-BrandBorder"
    >
      <h2
        class="mb-2 text-2xl font-bold tracking-wider text-center text-BrandHighlight retro-text"
      >
        Choose Your Username
      </h2>

      <p class="mb-6 text-center text-BrandSecondary retro-text">
        For people to message you, please select a username:
      </p>
      ...
      <div class="space-y-4">
        <div class="space-y-2">
          <label
            for="username"
            class="block text-sm font-medium text-BrandText"
          >

        ...
        <form onsubmit={saveUsername} class="space-y-6">
            <div class="p-4 mb-4 border rounded-lg bg-BrandSurface border-BrandBorder">
                <p class="mb-2 text-sm text-BrandSecondary">
                    <span class="font-bold text-red-400">Warning:</span> Updating your username is a <span class="font-bold">destructive</span> action. Everything associated with the current username will be deleted.
                </p>
            </div>
            <div class="space-y-2">
                <label for="edit-username" class="form-label">New Username <span class="text-red-500">*</span></label>

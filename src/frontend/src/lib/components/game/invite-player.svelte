...
<div class="bg-gradient-to-b from-[#522785] to-[#3d1d63] p-1 shadow-[4px_4px_0px_0px_rgba(0,0,0,0.3)]">
  ...
  <div class="bg-white p-4 border-2 border-black">
    ...
    {#if invitedPlayers.length > 0}
      <div class="border-2 border-[#FBB03B] p-3">
        <p class="text-xs font-black text-black uppercase mb-2">INVITED ({invitedPlayers.length}):</p>
        <div class="flex flex-wrap gap-2">
          {#each invitedPlayers as tag}
            <div class="flex items-center gap-2 bg-[#FBB03B] border border-black px-2 py-1">

<script lang="ts">
  ...
  import { modeLabel, statusLabel, tokenSymbol, profileName } from "$lib/utils/game-helper";
...
<div class="arcade-panel p-4 sm:p-6">
  ...
  <h2 class="text-xl sm:text-2xl font-black text-[#F4E04D] uppercase mb-4 sm:mb-6 break-words arcade-text-shadow">
    Host Control Center
  </h2>
